...
<html>
	<head>
		...
		<title>Informasi SMP | Bosowa School Makassar</title>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="<?php echo base_url()?>template/css/skins/default-smp.css">
			...
			<div role="main" class="main">
				...
				<section class="page-header">
					<div class="container">
						...
						<div class="row">
							<div class="col">
								<h1>SMP Bosowa School Makassar</h1>
							</div>
						</div>
					</div>
				</section>
