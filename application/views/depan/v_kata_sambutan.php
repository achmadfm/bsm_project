...
<html>
	<head>
		...
		<title>Sambutan Kepala Sekolah | Bosowa School Makassar</title>
				...
				<section class="page-header">
					...
					<div class="container">
						<div class="col-md-12">
							...
							<h2>Sambutan Kepala Sekolah Bosowa School Makassar</h2>
					...
					<div class="container">
						<div class="col-md-12">
							...
							<h2 align="right">Sambutan Kepala Sekolah Sekolah Alam Bosowa</h2>
							<div class="row">
								<div class="col-lg-4">
