...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>Informasi SD | Sekolah Alam Bosowa</title>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="<?php echo base_url()?>template/css/skins/default-sd.css">
	...
	<!-- Load Facebook SDK for JavaScript -->
		...
		<div class="body">
				...
				<div class="header-body">
                  ...
                  <div class="header-logo">
  									<a href="<?php echo base_url()?>">
  										<img alt="Porto" width="100" height="100" data-sticky-width="100" data-sticky-height="50" data-sticky-top="55" src="<?php echo base_url()?>materialize/SAB.png">
  									</a>
  								</div>
								</div>
							</div>
			...
			<div role="main" class="main">
				...
				<div class="center">
					<img class="img-responsive" src="<?php echo base_url()?>template/sd.jpg" width="1360px" alt="" />
				</div>
