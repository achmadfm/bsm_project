...
<head>
    ...
    <title>Web Administration - Admin Bosowa School Makassar</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="white-box">
                            <h3 class="box-title m-b-0">School History of Bosowa School Makassar</h3>
                        ...
                        <div class="white-box">
                            <h3 class="box-title m-b-0">School History of Sekolah Alam Bosowa</h3>
                            <p class="text-muted m-b-30 font-13"> (Form ini untuk mengedit sejarah sekolah) </p>
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-12">Isi Sejarah Sekolah (Saat ini)</label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="ids" value="<?php echo $sh['id_sejarah'];?>">
                                        <textarea class="form-control" rows="5" disabled><?php echo $sh['isi_sejarah'];?></textarea>
                                    </div>
                                </div>
                            </form>

                            <form class="form-horizontal" action="<?php echo base_url().'admin/web_admin/up_sejarah_sab'?>" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Isi Sejarah Sekolah (Baru)</label>
                                    <div class="col-md-12">
                    ...
                    <div class="col-sm-6">
                      <div class="white-box">
                          <h3 class="box-title m-b-0">Bosowa School Makassar Welcome Speech</h3>
                          ...
                          <?php $s = $speech->row_array();?>
                                ...
                                <div class="row">
                                  <div class="col-lg-6">
                                    <div class="form-group">
                                      ...
                                      <center><h3 class="box-title"><?php echo $s['nama_kepsek']?></h3> <small>Principal Bosowa School Makassar</small></center>
                                      <br/>
                                    </div>
                                  </div>
                                  <div class="col-lg-6">
                            ...
                            <div class="form-horizontal">
                              <div class="form-group">
                                  ...
                                  <div class="col-md-12">
                                      <input type="hidden" name="xkode" value="<?php echo $s['id_sambutan'];?>">
                                      <input type="hidden" name="xfoto" value="<?php echo $s['foto_sambutan'];?>">
                ...
                <div class="col-sm-6">
                  <div class="white-box">
                      <h3 class="box-title m-b-0">Sekolah Alam Bosowa Welcome Speech</h3>
                      <p class="text-muted m-b-30 font-13"> (Form ini untuk mengedit kata sambutan kepala sekolah) </p>
                      <?php $s = $speechsab->row_array();?>
                        <div class="form-group">
                          <label class="col-md-12">Foto (saat ini)</label>
                            <div class="row">
                              <div class="col-lg-6">
                                <div class="form-group">
                                  <input type="hidden" name="xkode" value="<?php echo $s['id_sambutan'];?>">
                                  <img height="370px" width="260px" src="<?php echo base_url().'template/speech/'.$s['foto_sambutan'];?>" class="img img-rounded" disabled>
                                  <center><h3 class="box-title"><?php echo $s['nama_kepsek']?></h3> <small>Principal Sekolah Alam Bosowa</small></center>
                                  <br/>
                                </div>
                              </div>
                              <div class="col-lg-6">
                        ...
                        <?php echo form_open_multipart('admin/web_admin/update_sambutan_sab');?>
                        <div class="form-horizontal">
                          <div class="form-group">
                              <label class="col-md-12">Isi Welcome Speech</label>
                              <div class="col-md-12">
